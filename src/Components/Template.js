...
const Template = ({ title, desc1, desc2, image, formtype, setIsLoggedIn }) => {
  ...
  return (
    <div className="flex justify-between flex-row w-11/12 max-w-[1160px] py-12 mx-auto gap-x-12 ">
      {/* Content Section */}
      ...
      <div className="relative w-11/12 max-w-[450px]">
        ...
        <img
          ...
          height={490}
          loading="lazy"
          className="absolute -top-4 right-4 rounded-lg w-[600px] h-[400px] object-cover"
        />
      </div>
    </div>
  );
